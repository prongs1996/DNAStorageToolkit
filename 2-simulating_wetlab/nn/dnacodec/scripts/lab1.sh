...
python3 $CODE_DIR/scripts/noise.py \
        --N ${coverage} \
        --subs $P --dels $P --inss $P  \
        --i $BASE_DIR/outputs/${config_file}/EncodedStrands.txt  \
        --o $BASE_DIR/outputs/${config_file}_P${P}_N${coverage}/UnderlyingClusters.txt
